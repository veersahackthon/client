...
const TESTIMONIALS_DATA = [
  [
    ...
    {
      image:
        "https://images.unsplash.com/photo-1512318601939-07bf29f1b74e?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80",
  ...
  [
    ...
    {
      image:
        "https://images.unsplash.com/photo-1488441770602-aed21fc49bd5?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1469&q=80",
  ...
  [
    {
      image:
        "https://images.unsplash.com/photo-1502021680532-838cfc650323?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=871&q=80",
  ...
  [
    {
      image:
        "https://images.unsplash.com/photo-1494794506681-b6de14f152f8?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1032&q=80",
      text: "I would like to take this oppertunity to thank SA Places for the great service rendered to us and in particular Estelle. You got me the best place ever in just a few moments after I spoke to you.",
      username: "@hello.mimmie",
      name: "Minnie Horn",
    },
  ...
  [
    {
      image:
        "https://images.unsplash.com/photo-1437652633673-cc02b9c67a1b?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=869&q=80",
      text: "I would just like to compliment Estelle Pestana. She has been most professional and gone to great lengths to assist me. Her patience with me as I continuously changed my plans is to be commended. Her service re-affirms why I always choose to book through an agency instead of directly. Thank you",
      username: "@hi.veona",
      name: "Veona Watson",
    },
  ...
  [
    ...
    {
      image:
        "https://images.unsplash.com/photo-1481956806014-1eae8e1c579a?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=869&q=80",
      text: "For our recent trip to S.A. I booked several accommodation thru SA Places. I just wanted to tell you that everything worked out perfectly with all the bookings and also your booking was very quick and professional. I hope I have the opportunity to re-visit South Africa soon, I will then make my bookings with your company again. I will also recommend",
      username: "@myself.thais",
      name: "Thais Carballal",
    },
  ...
  return (
    <>
      <div className="py-10 bg-gradient-to-b rounded-2xl">
        <div className="text-3xl md:text-4xl font-bold tracking-wide text-sky-600 uppercase px-5">
          {" "}
        ...
        <Swiper {...testimonialCarousel} className="swiper">
          {Data.map((item, index) => (
            <SwiperSlide key={index}>
              {/* {item.map(({ img, short, topic }, _index) => (
